...
R_HOME_DIR=
if test "${R_HOME_DIR}" = "/home/hxfeng/R/lib64/R"; then
   case "linux-gnu" in
   linux*)
     run_arch=`uname -m`
     case "$run_arch" in 
     ...
     if [ -x "/home/hxfeng/R/${libnn}/R/bin/exec/R" ]; then
        R_HOME_DIR="/home/hxfeng/R/${libnn}/R"
     elif [ -x "/home/hxfeng/R/${libnn_fallback}/R/bin/exec/R" ]; then
        R_HOME_DIR="/home/hxfeng/R/${libnn_fallback}/R"
